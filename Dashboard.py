...
### Facts and figures about earthquakes in the first half of the year 2021
...
def update_graph(option_slctd, option_slctd2):
    ...
    fig2 = px.density_heatmap(dff, x="Magnitude", range_x=(0, 8),
                              y="Depth",
    ...
    fig3 = px.density_mapbox(dff, lat='Latitude', lon='Longitude', z='Magnitude',
                             ...
                             template='plotly_dark')
    fig3.update_layout(title={'text': 'World map with place, magnitude, latitude, longitude and date'},
                       font=dict(family='Arial'))

    fig4 = px.bar(dff, x='Month', y='Magnitude',
                  color='Magnitude',
                  labels={'Magnitude': 'Magnitude'}, height=450)
